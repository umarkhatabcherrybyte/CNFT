...
//     try {
//       const raw = await this.Nami.getUsedAddresses();
...
//     console.log("getBalance  0 - 1  networkId = ", networkId);
...
//   async getAdaBalance() {
//     try {
//       const balanceCBORHex = await this.Nami.getBalance();
...
//       return balance;
//     } catch (err) {
//       console.log("getAdaBalance error =", err);
//       return null;
//     }
//   }
//   getApiKey(networkId) {
//     console.log(networkId);
//     //return "mainnetlv0OChqUomT4SeVeInZAib2BmyF6pCjx";
//     if (networkId == 0) {
...
//       console.log("[nami - submitTx]  9");
//       aux.set_metadata(generalMetadata);
//     } else {
//       aux = transaction.auxiliary_data();
//     }

//     console.log("[nami - submitTx]  10");
...
//     console.log("[nami - submitTx]  12 end");
//     return txhash;
//   }
//   async _getProtocolParameter(networkId) {
//     console.log("_getProtocolParameter 0 networkId=", networkId);
...
//       method: "GET",
//     });
//     console.log("_getProtocolParameter 1");
//     if (!latestBlock) throw ERROR.FAILED_PROTOCOL_PARAMETER;

//     console.log("_getProtocolParameter 2  latestBlock=", latestBlock);
...
//     console.log("_getProtocolParameter 3 p = ", p);
...
//     console.log("blockfrostApiKey = ", blockfrostApiKey);
